...
router.register(r"web-notifications/(?P<resource_id>\d+)/set-as-read", WebNotificationsViewSet,
...
from taiga.projects.api import CustomMembershipViewSet
...
# Newly added API.
router.register(r"project-members", CustomMembershipViewSet, base_name="project-member")
